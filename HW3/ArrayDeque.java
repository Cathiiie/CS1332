...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        if (data == null) {
            throw new java.lang.IllegalArgumentException("Can't add null at First.");
        }
    ...
    public void addLast(T data) {
        if (data == null) {
            throw new java.lang.IllegalArgumentException("Can't add null at last");
        }
        if (size == backingArray.length) {
            T[] newArr = (T[]) new Object[backingArray.length * 2];
    ...
    public T removeFirst() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty, can't removeFirst.");
        }
        T temp = backingArray[mod(front, backingArray.length)];
    ...
    public T removeLast() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty, can't removeLast.");
        }
        int index = mod(front + size - 1, backingArray.length);
    ...
    public T getFirst() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty, can't getFirst.");
        }
    ...
    public T getLast() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty, can't getLast.");
        }
